...
class ASRBase:
    ...
    def __init__(self, lan, device_type=None, modelsize=None, cache_dir=None, model_dir=None):
        self.transcribe_kargs = {}
        self.original_language = lan 

        self.model = self.load_model(device_type, modelsize, cache_dir, model_dir)

    def load_model(self, device_type, modelsize, cache_dir, model_dir):
...
#     def load_model(self, device_type=None, modelsize=None, cache_dir=None, model_dir=None):
...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, device_type="cpu_int8", modelsize=None, cache_dir=None, model_dir=None):
...
#             # print("%1.4f %1.0f %1.0f %s" % (now*1000, o[0]*1000,o[1]*1000,o[2]),flush=True,encoding="utf-8")
#             # for Python 3.10.0 later?
#         else:
